...
data class EstablishmentsQuery (
     ...
     *
     * You can use `-1` to get all results
     * even though the behavior is a bit weird.
     *
     * @default 10
     */
    val limit: Long = 10
...
suspend fun searchEstablishments (query: EstablishmentsQuery, client: HttpClient = HttpClient()): List<SearchedEstablishment> {
    val request = Request(1, "etablissements?q=${URLEncoder.encode(query.city ?: "", Charsets.UTF_8)}&code2p5=${query.code ?:  ""}&limit=${query.limit}")

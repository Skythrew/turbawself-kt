...
fun decodeBalance (balance: JsonObject): Balance {
    ...
    val estimationDate = LocalDateTime.parse(balance["montantEstimeMsg"]!!.jsonPrimitive.content.slice(18..<balance["montantEstimeMsg"]!!.jsonPrimitive.content.length).split('/').reversed().joinToString("-") +  "T12:00:00")

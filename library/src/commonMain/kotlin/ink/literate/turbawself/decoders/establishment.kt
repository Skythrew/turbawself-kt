...
fun decodeEstablishment(establishment: JsonObject) =
    Establishment(
        ...
        firstSyncDate =
            LocalDateTime.parse(
                establishment["datePremSynchro"]!!.jsonPrimitive.content.dropLast(1)),
        lastSyncDate =
            LocalDateTime.parse(
                establishment["dateDernSynchro"]!!.jsonPrimitive.content.dropLast(1)),
        lastSelfSyncDate =
            LocalDateTime.parse(
                establishment["configurationSelf"]!!
                    .jsonObject["dateDernSynchro"]!!
                    .jsonPrimitive
                    .content
                    .dropLast(1)),
        ...
        hideHistory =
            establishment["configuration"]!!.jsonObject["cacherHistorique"]!!.jsonPrimitive.boolean,
        reservations =
            establishment["configurationsReservation"]!!.jsonArray.map {
              Reservation(
        ...
        welcomeMessage =
            establishment["configuration"]!!.jsonObject["msgAccueil"]?.jsonPrimitive?.content,
        minimumMeals =
            establishment["configuration"]!!.jsonObject["nbRepasMini"]?.jsonPrimitive?.longOrNull
                ?: 0,
        minimumClaim =
            (establishment["configuration"]!!.jsonObject["creanceMini"]?.jsonPrimitive?.doubleOrNull
                    ?: 0)
                .toDouble(),
        minimumCredit =
            (establishment["configuration"]!!
                    .jsonObject["montantCreditMini"]
                    ?.jsonPrimitive
                    ?.doubleOrNull ?: 0)
                .toDouble(),
        permissions =
            Permissions(
                canStudentUseQrCode =
                    establishment["configuration"]!!
                        .jsonObject["autoriseQrCodeEleve"]!!
                        .jsonPrimitive
                        .boolean,
                canCompanionUseQrCode =
                    establishment["configuration"]!!
                        .jsonObject["autoriseQrCodeCommensal"]!!
                        .jsonPrimitive
                        .boolean,
                canInternUseQrCode =
                    establishment["configuration"]!!
                        .jsonObject["autoriseQrCodeStagiaire"]!!
                        .jsonPrimitive
                        .boolean,
            ))

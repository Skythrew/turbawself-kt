...
fun decodePayment(payment: JsonObject): Payment {
    ...
    return Payment(
        ...
        cancelURL = "https://espacenumerique.turbo-self.com/PagePaiementRefuse.aspx?token=$paymentToken",
        returnURL = "https://espacenumerique.turbo-self.com/PagePaiementValide.aspx?token=$paymentToken",
    )
}